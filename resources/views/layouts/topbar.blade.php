    ...
    <nav id="topbar">
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            <li class="menu single-menu active">
                <a href="{{ route('dashboard') }}" aria-expanded="true" class="">
                    <div class="">
            ...
            <li class="menu single-menu">
                <a href="{{ route('company.list') }}" aria-expanded="false" class="">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu single-menu">
                <a href="{{ route('user.list') }}" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu single-menu">
                <a href="{{ route('training.list') }}" data-toggle="collapse" aria-expanded="false"
                ...
                <ul class="collapse submenu list-unstyled" id="forms" data-parent="#topAccordion">
                    <li>
                        <a href="{{ route('training.create') }}"> Add Training </a>
                    </li>
                    <li>
                        <a href="{{ route('training.list') }}"> Training List </a>
                    </li>
                </ul>
            </li>
